...
# The writer currently being processed in each connection handling coroutine (used by handlers to read connection context)
...
# Return the StreamWriter for the current handler call
