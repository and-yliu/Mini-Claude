...
class SessionStore:
    ...
    # Return the directory path of the specified session
    def session_dir(self, sid: str) -> Path:
        return self._root / sid

    # Return the directory path of the runs under the specified session
    ...
    # Append an Anthropic API message to thread.jsonl
    def append_message(
        self,
        sid: str,
        role: str,
    ...
    # Append messages from a run to thread.jsonl
    def append_messages(
        self,
        sid: str,
    ...
    # Read the complete thread and return messages that can be passed directly to Anthropic
    ...
    # Overwrite thread.jsonl with compacted messages, backing up the original as thread_<ts>.jsonl.bak
    ...
    # Read the full text of notes.md, returning an empty string if the file does not exist
    ...
    # Append an active note to notes.md
